...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'easynote' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'easynote' ),
		'repeat-y'  => __( 'Repeat Vertically', 'easynote' ),
		'repeat'    => __( 'Repeat All', 'easynote' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'easynote' ),
		'top center'    => __( 'Top Center', 'easynote' ),
		'top right'     => __( 'Top Right', 'easynote' ),
		'center left'   => __( 'Middle Left', 'easynote' ),
		'center center' => __( 'Middle Center', 'easynote' ),
		'center right'  => __( 'Middle Right', 'easynote' ),
		'bottom left'   => __( 'Bottom Left', 'easynote' ),
		'bottom center' => __( 'Bottom Center', 'easynote' ),
		'bottom right'  => __( 'Bottom Right', 'easynote')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'easynote' ),
		'fixed'  => __( 'Fixed in Place', 'easynote')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'easynote' ),
		'italic'      => __( 'Italic', 'easynote' ),
		'bold'        => __( 'Bold', 'easynote' ),
		'bold italic' => __( 'Bold Italic', 'easynote' )
		);
