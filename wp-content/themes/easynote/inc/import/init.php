...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		 ...
		 * Set framewok
		 *
		 * options that can be used are 'default', 'radium' or 'optiontree' (and now 'optionsframework')
		 *
		 * @since 0.0.3
		 *
		 * @var string
		 */
		public $theme_options_framework = 'optionsframework';
		 ...
		 * @var string
		 */
		public $theme_option_name       = 'easynote'; //set theme options name here (key used to save theme options). Optiontree option name will be set automatically
